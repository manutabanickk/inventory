<?php
	...
	$count_creditos = $objCredito->Count_Creditos_Proveedor();
						 ...
						 <div class="panel-body">
							 <table class="table datatable-basic table-xs table-hover">
								 ...
								 <tbody>
									 ...
									 <?php
										 $filas = $objCredito->Listar_Creditos_Proveedor(0);
														 ...
														 <li class="dropdown">
															 ...
															 <ul class="dropdown-menu dropdown-menu-right">
																 ...
																 onclick="openCredito('editar',
																		'<?php print($column["idcreditoproveedor"]); ?>',
																	...
																	data-id="<?php print($column['idcreditoproveedor']); ?>"
																 href="javascript:void(0)">
																	<i class="icon-file-spreadsheet">
																		</i> Ver Detalle</a></li>

																		<li><a id="print_estado"
																	data-id="<?php print($column['codigo_credito'].','.$column['idcreditoproveedor']); ?>"
																 href="javascript:void(0)">
						 ...
						 <div class="panel-body">
							 <table class="table datatable-basic table-xs table-hover">
								 ...
								 <tbody>
									 ...
									 <?php
										 $filas = $objCredito->Listar_Creditos_Proveedor(1);
										 if (is_array($filas) || is_object($filas))
										 {
										 foreach ($filas as $row => $column)
										 {
			 ...
			 <div class="tab-pane" id="label-tab3">
				 ...
				 <div class="panel panel-flat">
					 <div class="panel-heading">
						 ...
						 <div class="heading-elements">
							 <?php $filas = $objCredito->Listar_Creditos_Proveedor(0);
							 if (is_array($filas) || is_object($filas))
							 { ?>
						 ...
						 <div class="panel-body">
							 <table class="table datatable-basic table-xs table-hover">
								 ...
								 <tbody>
									 ...
									 <?php
										 $filas = $objCredito->Listar_Abonos_Proveedor_All();
										 if (is_array($filas) || is_object($filas))
										 {
										 foreach ($filas as $row => $column)
										 {
														 ...
														 <li class="dropdown">
															 ...
															 <ul class="dropdown-menu dropdown-menu-right">
																 ...
																 onclick="openAbono('ver',
																		'<?php print($column["idabonoproveedor"]); ?>',
																		'<?php print($column['codigo_credito']); ?>',
																	...
																	<?php if($tipo_usuario==1){ ?>
																		 ...
																		 data-id="<?php print($column['idabonoproveedor']); ?>"
																		 href="javascript:void(0)">
																		 <i class=" icon-trash">
																		 </i> Borrar</a></li>
																	<?php } ?>
																	...
																	onclick="Print_Ticket('<?php print($column["idabonoproveedor"]); ?>')">
...
<script type="text/javascript" src="web/custom-js/creditoproveedor.js"></script>
